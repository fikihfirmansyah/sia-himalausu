...
<div class="panel panel-info">
	<div class="panel-heading" style="overflow: auto">
		...
		<div class="col-md-2">
			<a href="<?php echo base_URL(); ?>sekretaris/surat_keluar/add" class="btn btn-info"><i class="icon-plus-sign icon-white"> </i> Tambah Data</a>
		</div>
		<div class="col-md-4"></div>
		<div class="col-md-4">
			<form class="navbar-form navbar-left" method="post" action="<?php echo base_URL(); ?>sekretaris/surat_keluar/cari" style="margin-top: 0px">
	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
				...
				?>
				<div class="btn-group">
					<a href="<?php echo base_URL()?>sekretaris/surat_keluar/edt/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
					<a href="<?php echo base_URL()?>sekretaris/surat_keluar/del/<?php echo $b->id?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
