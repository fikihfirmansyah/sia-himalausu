...
<div class="panel panel-info">
	<div class="panel-heading"><h3 style="margin-top: 5px">Manage Sekretaris</h3></div>
</div>
	
	<form action="<?php echo base_URL(); ?>sekretaris/manage_admin/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		...
		<a href="<?php echo base_URL(); ?>sekretaris/manage_admin" class="btn btn-success" tabindex="8" ><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
	...
	<div class="col-lg-6">	
		...
		<tr><td width="20%">Level</td><td><b>
			...
			<?php
				$l_sifat	= array('Super Sekretaris','Sekretaris');
