...
<div class="well">
<form action="<?php echo base_URL(); ?>sekretaris/cetak_agenda" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
	...
	<a href="<?php echo base_URL(); ?>sekretaris" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
	</td></tr>
	</table>
	</fieldset>
</form>
