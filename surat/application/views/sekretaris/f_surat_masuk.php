...
?>
	...
	<form action="<?php echo base_URL(); ?>sekretaris/surat_masuk/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		...
		<a href="<?php echo base_URL(); ?>sekretaris/surat_masuk" class="btn btn-success" tabindex="11" ><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
