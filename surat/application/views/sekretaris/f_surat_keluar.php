...
?>
	...
	<form action="<?php echo base_URL()?>sekretaris/surat_keluar/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		...
		<a href="<?php echo base_URL()?>sekretaris/surat_keluar" tabindex="10" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
