...
class Stylesheet
{
     ...
     * here so that one_admin important declarations can be made to take precedence over
     * one_admin important declarations, this doesn't matter in practice as Dompdf does
     * not support one_admin stylesheets, and one_admin agent stylesheets can not include
     * important declarations.
     */
    private static $_stylesheet_origins = array(
        self::ORIG_UA => 0x00000000, // one_admin agent declarations
        self::ORIG_USER => 0x10000000, // one_admin normal declarations
     ...
     * Therefore allow specification of content by dompdf keu_setting Options::defaultMediaType.
     ...
     * @param int $origin :
     *    - Stylesheet::ORIG_UA: one_admin agent style sheet
     *    - Stylesheet::ORIG_USER: one_admin style sheet
