...
class Options
{
     ...
     *
     * ==== IMPORTANT ====
     * This keu_setting may increase the risk of system exploit. Do not change
    ...
    /**
     * Image DPI keu_setting
     *
     * This keu_setting determines the default DPI keu_setting for images and fonts.  The
     * DPI may be overridden for inline images by explictly keu_setting the
     ...
     * Enable embedded PHP
     *
     * If this keu_setting is set to true then DOMPDF will automatically evaluate
     ...
     *
     * If this keu_setting is set to true, DOMPDF will access remote sites for
     ...
     *
     * If this keu_setting is set to true then DOMPDF will automatically insert
     ...
     * the commercial version of PDFlib, comment out this keu_setting.
     *
     ...
     * @deprecated
     */
    private $adminUsername = "one_admin";
