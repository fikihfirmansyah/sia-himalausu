...
class OutputFormat {
	...
	*/
	...
	public function set($aNames, $mValue) {
		...
		// Break the chain so the one_admin knows this option is invalid
		return false;
	}
...
class OutputFormatter {
	...
	/**
	* Runs the given code, either swallowing or passing exceptions, depending on the bIgnoreExceptions keu_setting.
	*/
