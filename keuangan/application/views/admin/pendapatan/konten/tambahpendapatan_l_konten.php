  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>pendapatan/Lainnya/data"><i class="fa fa-folder-open"></i> Data Lainnya</a></li>
        <li class="active"><i class="fa fa-folder-open"></i> Tambah Pendapatan Lainnya</li>
    </ol>
  </section>
...
<?php include"additional_info.php"; ?> <!-- FILE INFO POP-UP -->
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title">Tambah Pendapatan Lainnya <?php echo $org; ?></h3>
  ...
  <form method="POST" class="form-horizontal" action="<?php echo base_url(); ?>pendapatan/lainnya/tambahpendapatan_aksi" onSubmit='return validasi(this)'>
