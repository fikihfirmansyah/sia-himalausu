  ...
  <?php foreach ($keu_departemen as $r ) {?>
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title">Edit Program Kerja Departemen <?php echo $r->nama_departemen; ?></h3>
    ...
    <?php foreach ($progja as $row ) {?>
      <div class="col-md-12 box-body">
  <?php echo (isset($_GET['error']))? "<div class='alert alert-danger'>$_GET[error]</div>" : ""; ?>

  <form method="POST" class="form-horizontal" action="<?php echo base_url(); ?>departemen/progjadepartemen/editprogja_aksi/<?php echo $row->id_progja; ?>">
    <input type="text" name="id_departemen" value="<?php echo $_GET['keu_departemen'];?>" hidden>
    <div class='form-group'>
          <label class='col-sm-3 control-label'>Program Kerja :</label>
            <div class='col-sm-8'>
              <input type="text" class="form-control" name="t_progja" value="<?php echo $row->nama_progja; ?>" required>
            </div>
    </div>
    <div class='form-group'>
          <label class='col-sm-3 control-label'>Estimasi Biaya :</label>
            <div class='col-sm-8'>
                <input type="text" class="form-control"  id="rupiah" name="t_biaya" value="<?php echo $row->estimasi_biaya; ?>" required>
            </div>
    </div>
    <div class='form-group'>
          <label class='col-sm-3 control-label'></label>
            <div class='col-sm-8'>
              <a href="<?php echo base_url(); ?>departemen/progjadepartemen/detail/?id=<?php echo $_GET['keu_departemen'];?>" title="Kembali" class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i> Kembali</a>
