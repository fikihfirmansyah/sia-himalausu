...
<?php include"additional_info.php"; ?> <!-- FILE INFO POP-UP -->
  ...
  <form method="POST" class="form-horizontal" action="<?php echo base_url(); ?>departemen/daftardepartemen/editdepartemen_aksi/?id=<?php echo $row->id_departemen; ?>">
    <div class='form-group'>
          <label class='col-sm-3 control-label'>Nama Departemen :</label>
            <div class='col-sm-8'>
              <input type="text" class="form-control" name="t_departemen" value="<?php echo $row->nama_departemen; ?>">
            </div>
    </div>
    <div class='form-group'>
